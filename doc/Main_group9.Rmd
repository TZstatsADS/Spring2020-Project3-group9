...
# save the data to csv format to use in python
write.csv(dat_train,"../data/train_set/dat_train.csv",row.names = FALSE)
write.csv(dat_test,"../data/train_set/dat_test.csv",row.names = FALSE)
