...
[Contribution Statement] (In the following context, "all team members" refers to the team meambers listed above.) All team members listed above discussed and decided the models to build in this project.
  ...
  For the other work, Rui integrated the codes of main file, with Huize providing some edits. Qin and Mengchen worked on the presentation slides. Qin is also the presenter of our group. Huize contributed to the readme files and contribution statement on github.
